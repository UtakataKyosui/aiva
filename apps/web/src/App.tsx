...
const App = () => {
  ...
  const loadDashboard = async () => {
    ...
    try {
      const [nextIngredients, nextMeals, nextPreferences, nextSuggestion] = await Promise.all([
        api.getIngredients(),
        api.getMeals(),
        api.getPreferences(),
      ...
      setError(nextError instanceof Error ? nextError.message : 'データの取得に失敗しました。');
    } finally {
      setBusy(false);
    }
  };
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setBusy(false);
      setError(nextError instanceof Error ? nextError.message : 'Google ログインに失敗しました。');
    }
  };
  ...
  const handleIngredientSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(nextError instanceof Error ? nextError.message : '食材の保存に失敗しました。');
    } finally {
      setBusy(false);
    }
  };
  ...
  const handleMealSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(nextError instanceof Error ? nextError.message : '食事記録の保存に失敗しました。');
    } finally {
      setBusy(false);
    }
  };
  ...
  const handlePreferencesSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(nextError instanceof Error ? nextError.message : '個人条件の保存に失敗しました。');
    } finally {
      setBusy(false);
    }
  };
  ...
  const handleGenerateSuggestion = async () => {
    ...
    try {
      ...
      setError(nextError instanceof Error ? nextError.message : '提案生成に失敗しました。');
    } finally {
      setBusy(false);
    }
  };
  ...
  const deleteIngredient = async (id: string) => {
    ...
    try {
      ...
      setError(nextError instanceof Error ? nextError.message : '食材の削除に失敗しました。');
    } finally {
      setBusy(false);
    }
  };
  ...
  const deleteMeal = async (id: string) => {
    ...
    try {
      ...
      setError(nextError instanceof Error ? nextError.message : '食事記録の削除に失敗しました。');
    } finally {
      setBusy(false);
    }
  };
  ...
  const expiringSoon = ingredients.filter(
    (ingredient) => ingredient.expiresOn && ingredient.expiresOn <= new Date(Date.now() + 1000 * 60 * 60 * 24 * 3).toISOString().slice(0, 10),
  );
      ...
      {!session ? (
        ...
        <>
          <section className="summary-grid">
            ...
            <article className="metric-card">
              <span>今日の提案</span>
              <strong>{suggestion ? '生成済み' : '未生成'}</strong>
            </article>
          </section>
                ...
                <div className="form-grid">
                  ...
                  <label>
                    ...
                    <select
                      ...
                      onChange={(event) =>
                        setIngredientForm((current) => ({ ...current, category: event.target.value as IngredientInput['category'] }))
                      }
                    >
                      {['野菜', '果物', '肉', '魚', '卵・乳製品', '穀物', '豆・大豆製品', '調味料', '冷凍食品', 'その他'].map(
                        (category) => (
                  ...
                  <label>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setIngredientForm((current) => ({ ...current, quantity: Number(event.target.value) }))
                      }
                      required
                    />
                  </label>
                  <label>
                    ...
                    <select
                      ...
                      onChange={(event) =>
                        setIngredientForm((current) => ({ ...current, unit: event.target.value as IngredientInput['unit'] }))
                      }
                    >
                      {['g', 'kg', 'ml', 'l', '個', '本', '袋', 'パック', '枚', '食分'].map((unit) => (
                  ...
                  <label>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setIngredientForm((current) => ({ ...current, expiresOn: asNullableText(event.target.value) }))
                      }
                    />
                  </label>
                  <label>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setIngredientForm((current) => ({ ...current, calories: asNullableNumber(event.target.value) }))
                      }
                    />
                  </label>
                  <label>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setIngredientForm((current) => ({ ...current, protein: asNullableNumber(event.target.value) }))
                      }
                    />
                  </label>
                  <label>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setIngredientForm((current) => ({ ...current, fat: asNullableNumber(event.target.value) }))
                      }
                    />
                  </label>
                  <label>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setIngredientForm((current) => ({ ...current, carbs: asNullableNumber(event.target.value) }))
                      }
                    />
                  </label>
                  <label className="full-width">
                    ...
                    <textarea
                      ...
                      onChange={(event) =>
                        setIngredientForm((current) => ({ ...current, note: asNullableText(event.target.value) }))
                      }
                      rows={2}
                    />
                  </label>
                ...
                <div className="form-grid">
                  <label>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setMealForm((current) => ({ ...current, consumedOn: event.target.value }))
                      }
                    />
                  </label>
                  <label>
                    ...
                    <select
                      ...
                      onChange={(event) =>
                        setMealForm((current) => ({ ...current, mealType: event.target.value as MealLogInput['mealType'] }))
                      }
                    >
                      {['朝食', '昼食', '夕食', '間食'].map((mealType) => (
                  ...
                  <label className="full-width">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setMealForm((current) => ({ ...current, menuName: event.target.value }))
                      }
                  ...
                  <label>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setMealForm((current) => ({ ...current, satisfaction: asNullableNumber(event.target.value) }))
                      }
                    />
                  </label>
                  <label className="full-width">
                    ...
                    <textarea
                      value={mealForm.note ?? ''}
                      onChange={(event) =>
                        setMealForm((current) => ({ ...current, note: asNullableText(event.target.value) }))
                      }
                      rows={2}
                    />
                  </label>
                ...
                <div className="form-grid">
                  <label className="full-width">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setPreferenceDraft((current) => ({ ...current, allergies: event.target.value }))
                      }
                      placeholder="例: えび, かに"
                    />
                  </label>
                  <label className="full-width">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setPreferenceDraft((current) => ({ ...current, dislikes: event.target.value }))
                      }
                  ...
                  <label className="full-width">
                    ...
                    <textarea
                      ...
                      onChange={(event) =>
                        setPreferenceDraft((current) => ({ ...current, note: event.target.value }))
                      }
                      rows={3}
